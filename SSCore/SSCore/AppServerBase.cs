...
namespace SSCore
{
    ...
    public abstract partial class AppServerBase<TAppSession, TRequestInfo> : IAppServer<TAppSession, TRequestInfo>, IDisposable where TRequestInfo : class, IRequestInfo
